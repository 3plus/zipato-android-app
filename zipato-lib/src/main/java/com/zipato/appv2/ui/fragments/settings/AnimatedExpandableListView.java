...
public class AnimatedExpandableListView extends ExpandableListView {
     ...
     * to reset all of it's view. This time however, depending on whether a
     ...
     * ExpandableListView to reset all views on screen. The way that
     ...
     * the ExpandableListView is forced to reset it's views again, except this
     ...
     * 9. This forces the ExpandableListView to reset all of it's views again.
    ...
    public boolean collapseGroupWithAnimation(int groupPos) {
        ...
        // Force the listview to reset it's views
